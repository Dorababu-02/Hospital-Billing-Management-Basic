    ...
    try {
        ...
        if (result.success && Array.isArray(result.data)) {
            ...
            result.data.forEach((item) => {
                ...
                const total = parseFloat(item.labTests || 0) +
                            parseFloat(item.medicines || 0) +
                            parseFloat(item.consultationFees || 0) +
                            parseFloat(item.roomCost || 0);
        ...
        tableBody.innerHTML = '<tr><td colspan="6">Server error. Could not load data.</td></tr>';
    }
...
function attachDownloadListeners() {
    ...
    <body>
        ...
        <div class="footer">&copy; 2025 Hospital Billing Management System</div>
    </body>
    </html>
`;
